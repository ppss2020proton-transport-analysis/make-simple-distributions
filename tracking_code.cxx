...
class ProtonTransport {
  public:
    ...
    void simple_tracking(double, string);
...
void ProtonTransport::simple_tracking(double obs_point, string opticsFileName){
  ...
  string fileNumber;
  if (opticsFileName[26] == '1') {
    fileNumber = "1";
  } else {
    fileNumber = "2";
  }
  string opticsROOTFileName = "root_PPSS_2020/" + fileNumber + "pythia8_13TeV_protons_100k_transported_205m" + 
                              opticsFileName.substr(opticsFileName.find("_beta")) + 
                              ".root";
  std::cout << "The ROOT output file: " << opticsROOTFileName << std::endl << std::endl; 
  TFile * p = new TFile(opticsROOTFileName.c_str(),"recreate");
